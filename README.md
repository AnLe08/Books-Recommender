...
This project was initially created in Python 3.13. In order to run the project, the following dependencies are required:
...
To create your vector database, if you have an OpenAI API key, you can use it; otherwise, using a model from Hugging Face is a nice choice too.

The data for this project can be downloaded from Kaggle (7K books).
